...
public class MineIron extends JFrame implements ActionListener, MouseListener{
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==btnOre1) {
			...
			if(ore1.hp==0) {
				btnOre1.setIcon(new ImageIcon(MineStone.class.getResource("/img/ore/ironBroken.png")));
			}
		}
		if (e.getSource()==btnOre2) {
			hitOre(ore2,oreHpBar2,btnOre2);
			if(ore2.hp==0) {
				btnOre2.setIcon(new ImageIcon(MineStone.class.getResource("/img/ore/ironBroken.png")));
			}
		}
		if (e.getSource()==btnOre3) {
			hitOre(ore3,oreHpBar3,btnOre3);
			if(ore3.hp==0) {
				btnOre3.setIcon(new ImageIcon(MineStone.class.getResource("/img/ore/ironBroken.png")));
			}
		}
		if (e.getSource()==btnOre4) {
			hitOre(ore4,oreHpBar4,btnOre4);
			if(ore4.hp==0) {
				btnOre4.setIcon(new ImageIcon(MineStone.class.getResource("/img/ore/ironBroken.png")));
			}
		}
		if (e.getSource()==btnOre5) {
			hitOre(ore5,oreHpBar5,btnOre5);
			if(ore5.hp==0) {
				btnOre5.setIcon(new ImageIcon(MineStone.class.getResource("/img/ore/ironBroken.png")));
			}
		}
	}
